...
/**
 * Instrumented test to verify the weather feature for "Detroit".
 * This test ensures that the user can view weather-related information
 * for the city of Detroit and that all expected UI components are displayed.
 */
@RunWith(AndroidJUnit4.class)
public class WeatherFeatureDetroitTest {
         ...
         * and ensures that "Detroit" is present in the list of cities.
         */
        @Before
        public void setUp() {
                ...
                // Ensure the city "Detroit" exists in the city list
        ...
        /**
         * Test to verify the weather feature for "Detroit".
         * Checks that all relevant UI components related to weather information are
         * displayed correctly.
         */
        @Test
        public void testWeatherFeatureDetroit() {
                // Verify that "Detroit" is displayed in the city list
                onView(withText("Detroit"))
                                .perform(scrollTo())
                                .check(matches(isDisplayed()));

                // Click the weather button for "Detroit"
                onView(withTagValue(equalTo("weather_button_Detroit")))
                                .perform(scrollTo(), click());
                sleep(1000);
